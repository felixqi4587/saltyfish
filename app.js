...
window.I18N = {
  zh: {
    ...
    def_panel_hint: "挑当场正在来袭的那条敌鲸，照大字发兵。绿点=你发兵（最关键，会停顿提示）→ 红点=敌落地 → 蓝点=补满。补兵带纯兵、可加速。",
  ...
  en: {
    ...
    def_panel_hint: "Pick the whale currently attacking and send by the big text. Green = you send (most important, pauses) → red = enemy lands → blue = refilled. Send pure troops, speedups OK.",
