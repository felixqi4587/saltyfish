...
window.I18N = {
  zh: {
    ...
    st_ok: "✓ 刚兑换", st_already: "✓ 已兑换", st_expired: "码过期", st_invalid: "码无效", st_usedup: "已用尽", st_limited: "⚠ 限量抢光", st_bad_fid: "FID错误", st_rate: "限流稍后", st_capped: "超上限,下次", st_err: "失败", st_pending: "待验证",
  ...
  en: {
    ...
    st_ok: "✓ Just redeemed", st_already: "✓ Already", st_expired: "Expired", st_invalid: "Invalid", st_usedup: "Used up", st_limited: "⚠ Limit reached", st_bad_fid: "Bad FID", st_rate: "Rate-limited", st_capped: "Capped, next time", st_err: "Failed", st_pending: "validating",
